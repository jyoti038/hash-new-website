...
export default function TermsModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md px-4">
      ...
      {/* Horizontal Modal Container */}
      <div
        className={`relative w-full max-w-6xl h-[80vh] rounded-2xl shadow-2xl border border-green-500/30 overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          {/* Header */}
          <div className="flex items-center justify-between px-8 py-5 border-b border-green-500/30">
          ...
          {/* Scrollable Content */}
          <div className="flex-1 overflow-y-auto px-8 py-6 text-gray-200 leading-7 space-y-6 text-justify">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://hashforgamers.co.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>

            <p>
              The Platform is owned by Hashforgamers Pvt Ltd, a company incorporated under the Companies Act, 1956 with its registered office at A-104 Asmita Garden -1 Poonam Sagar Mira Road Mumbai, Mumbai, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
            </p>
            ...
            <p>
              All disputes arising out of or in connection with these Terms shall be subject to the exclusive Mumbai Maharashtra jurisdiction of the courts.
            </p>
